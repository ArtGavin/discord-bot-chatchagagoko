        ...
        try:
            embed = discord.Embed(
                ...
                description=(
                    ...
                    "**🧩 โปรแกรมรวมเซิฟ**\n"
                    "📥 **ติดตั้งโปรแกรม:**\n"
                    "👉 [คลิกเพื่อติดตั้ง](https://drive.google.com/file/d/1GWh7KqAzBOI9iVpoAVpw7J31AxL3WYQ9/view?usp=sharing)\n"
                    "📺 **วิธีติดตั้งและใช้งาน:**\n"
                    "🎬 [คลิกเพื่อดูวิดีโอ](https://www.youtube.com/watch?v=8EofTTfj1wg)\n\n"
                    "**⏱️ โปรแกรมนับวิน**\n"
                    "📥 **ติดตั้งโปรแกรม:**\n"
                    "👉 [คลิกเพื่อติดตั้ง](https://drive.google.com/file/d/1hDu45Zh5qhWn4Bllk4hu-ggBfFDI5xuY/view?usp=sharing)\n"
                    "📺 **วิธีติดตั้งและใช้งาน:**\n"
